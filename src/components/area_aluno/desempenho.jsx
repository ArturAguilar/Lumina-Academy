    ...
    <main className="min-h-screen bg-gray-50 p-4">
      ...
      <div className="flex justify-center mb-8">
        <div className="bg-gray-100 rounded-xl flex overflow-hidden">
          <button className="px-6 py-2 text-xs sm:text-sm font-semibold focus:outline-none transition-all bg-[#3b82f6] text-white shadow-none" style={{borderRadius: '0.75rem 0 0 0.75rem'}}>Esta Semana</button>
          <button className="px-6 py-2 text-xs sm:text-sm font-semibold focus:outline-none transition-all bg-transparent text-gray-800 hover:bg-gray-200">Este Mês</button>
          <button className="px-6 py-2 text-xs sm:text-sm font-semibold focus:outline-none transition-all bg-transparent text-gray-800 hover:bg-gray-200" style={{borderRadius: '0 0.75rem 0.75rem 0'}}>Este Ano</button>
        </div>
      </div>
      {/* Gráficos */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow p-6 flex flex-col justify-between">
          <div className="flex items-center justify-between mb-2">
            <span className="font-semibold text-lg md:text-xl">Tempo de Estudo Diário</span>
            <span className="text-blue-600 text-xs sm:text-sm flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-blue-500 inline-block"></span>Horas estudadas</span>
          </div>
        ...
        <div className="bg-white rounded-xl shadow p-6 flex flex-col justify-between">
          <div className="flex items-center justify-between mb-2">
            <span className="font-semibold text-lg md:text-xl">Desempenho por Matéria</span>
            <a href="#" className="text-blue-600 text-xs sm:text-sm font-medium hover:underline">Ver detalhes</a>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 mt-6">
            <div className="flex items-center gap-2 text-xs sm:text-sm"><span className="w-4 h-4 rounded-full inline-block" style={{background:'#3b82f6'}}></span><span className="text-gray-700">Matemática</span></div>
            <div className="flex items-center gap-2 text-xs sm:text-sm"><span className="w-4 h-4 rounded-full inline-block" style={{background:'#a855f7'}}></span><span className="text-gray-700">Português</span></div>
            <div className="flex items-center gap-2 text-xs sm:text-sm"><span className="w-4 h-4 rounded-full inline-block" style={{background:'#818cf8'}}></span><span className="text-gray-700">Inglês</span></div>
            <div className="flex items-center gap-2 text-xs sm:text-sm"><span className="w-4 h-4 rounded-full inline-block" style={{background:'#f472b6'}}></span><span className="text-gray-700">Espanhol</span></div>
            <div className="flex items-center gap-2 text-xs sm:text-sm"><span className="w-4 h-4 rounded-full inline-block" style={{background:'#f59e42'}}></span><span className="text-gray-700">Literatura</span></div>
            <div className="flex items-center gap-2 text-xs sm:text-sm"><span className="w-4 h-4 rounded-full inline-block" style={{background:'#fbbf24'}}></span><span className="text-gray-700">Arte</span></div>
            <div className="flex items-center gap-2 text-xs sm:text-sm"><span className="w-4 h-4 rounded-full inline-block" style={{background:'#10b981'}}></span><span className="text-gray-700">Física</span></div>
            <div className="flex items-center gap-2 text-xs sm:text-sm"><span className="w-4 h-4 rounded-full inline-block" style={{background:'#06b6d4'}}></span><span className="text-gray-700">Química</span></div>
            <div className="flex items-center gap-2 text-xs sm:text-sm"><span className="w-4 h-4 rounded-full inline-block" style={{background:'#22c55e'}}></span><span className="text-gray-700">Biologia</span></div>
            <div className="flex items-center gap-2 text-xs sm:text-sm"><span className="w-4 h-4 rounded-full inline-block" style={{background:'#eab308'}}></span><span className="text-gray-700">História</span></div>
            <div className="flex items-center gap-2 text-xs sm:text-sm"><span className="w-4 h-4 rounded-full inline-block" style={{background:'#f43f5e'}}></span><span className="text-gray-700">Filosofia</span></div>
            <div className="flex items-center gap-2 text-xs sm:text-sm"><span className="w-4 h-4 rounded-full inline-block" style={{background:'#6366f1'}}></span><span className="text-gray-700">Sociologia</span></div>
            <div className="flex items-center gap-2 text-xs sm:text-sm"><span className="w-4 h-4 rounded-full inline-block" style={{background:'#0ea5e9'}}></span><span className="text-gray-700">Geografia</span></div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
        ...
        <div className="bg-white rounded-xl shadow p-6 flex flex-col min-w-[260px]">
          <span className="font-semibold text-base md:text-lg text-gray-900 mb-4">Metas da Semana</span>
        ...
        {/* Conquistas Recentes */}
        <div className="bg-white rounded-xl shadow p-6 flex flex-col min-w-[260px]">
          <span className="font-semibold text-base md:text-lg text-gray-900 mb-4">Conquistas Recentes</span>
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <span className="font-semibold text-gray-800 text-xs sm:text-sm block">Sequência de 15 dias</span>
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <span className="font-semibold text-gray-800 text-xs sm:text-sm block">Mestre em Matemática</span>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="font-semibold text-gray-800 text-xs sm:text-sm block">100 Exercícios</span>
        ...
        <div className="bg-white rounded-xl shadow p-6 flex flex-col items-center min-w-[260px]">
          <span className="font-semibold text-base md:text-lg text-gray-900 mb-4">Consistência de Estudos</span>
          ...
          <span className="text-gray-500 text-xs sm:text-sm mb-1">Dias estudados este mês</span>
          <span className="text-lg md:text-xl font-bold text-gray-800">24 de 30 dias</span>
        </div>
      </div>
    {/* Card de Desempenho Detalhado por Matéria */}
    <div className="bg-white rounded-xl shadow p-6 mt-8">
      <div className="flex items-center justify-between mb-4">
        <span className="font-semibold text-lg md:text-xl">Desempenho Detalhado por Matéria</span>
        <button className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-4 py-2 rounded flex items-center gap-2 text-xs sm:text-sm transition-all">
